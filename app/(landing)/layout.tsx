        ...
        <div className="mx-auto max-w-7xl px-4 py-10">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="flex flex-wrap gap-4 text-sm text-slate-500">
              ...
              <a href="tel:++573180066892" className="hover:text-white transition-colors">+57 316 137 4657</a>
              <a href="https://wa.me/+573180066892" target="_blank" rel="noopener noreferrer" className="hover:text-green-400 transition-colors">WhatsApp</a>
